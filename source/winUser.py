...
def getWindowStyle(hwnd):
	# Window style constants are positive.
	# However,GetWindowLong returns a long, which can be negative.
	return c_ulong(user32.GetWindowLongW(hwnd,GWL_STYLE)).value
